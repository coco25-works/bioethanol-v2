...
3. `deliverables/05_strategy_outputs/executive_strategy_summary.md` - portfolio answer
4. `deliverables/05_strategy_outputs/se_asia_producer_opportunity_map.md` - route-by-route view
5. `deliverables/04_market_analysis/global_market_comparison.md` - market comparison
